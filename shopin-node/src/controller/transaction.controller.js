            ...
            if (walletListFromNode && walletListFromNode.length > 0) {
              ...
              try {
                ...
                if (parseInt(_walletAvailability.balance) < _walletA_Bal) {
                  ...
                  singleTransactionObject.tokenInfo = req.body.tokenInfo
                  singleTransactionObject.number = req.body.number
                  singleTransactionObject.isLast = req.body.isLast
              ...
              if (innerTransaction && receiverTransaction) {
                ...
                if (
                  ...
                  try {
                    ...
                    newTransactionObject.tokenInfo = req.body.tokenInfo
                    newTransactionObject.number = req.body.number
                    newTransactionObject.isLast = req.body.isLast                  
                    ...
                    node.iterativeStore(
                      ...
                      function(_err, response) {
                        ...
                        let inValue = valueFromBSet ? valueFromBSet.in: [];
                            // store using set of B        
                        node.iterativeStore(
                          Buffer.from(
                          ...
                          {
                            in: [...inValue, transactionUniqueId],
                            out: []
                          },
                          function(_err, response) {
                            if (_err) {
                    ...
                    console.log("going to store");
                        ...
                        node.iterativeStore(
                          ...
                          function(_err, response) {
                            ...
                            let outValue = valueFromASet ? valueFromASet.out: []
                            // store using set of A        
                            node.iterativeStore(
                              Buffer.from(
                                md5(`${_walletA}_tx_set_${storeInNewSetA ? innerTransaction.transaction_set + 1 : innerTransaction.transaction_set}`).concat('00000000'),
                              ...
                              {
                                in: [],
                                out: [ ...outValue, transactionUniqueId ]
                              },
                              function(_err, response) {
                                if (_err) {
                                  // res.json(err);
                            ...
                            const inValue = valueFromBSet ? valueFromBSet.in : [];
                                // store using set of B        
                            node.iterativeStore(
                              Buffer.from(
                                md5(`${_walletB}_tx_set_${storeInNewSetB ? receiverTransaction.transaction_set + 1 : receiverTransaction.transaction_set}`).concat('00000000'),                            
