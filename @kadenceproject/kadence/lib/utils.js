...
module.exports.scrypt = function(input, callback) {
  ...
  if (typeof callback === 'function') {
    return crypto.scrypt(input, salt, length, params, callback);
  } else {
    return crypto.scryptSync(input, salt, length, params);
  }
};
...
module.exports.toExtendedFromPrivateKey = function(priv) {
  ...
  hdKeyPair.chainCode = Buffer.alloc(32).fill(0);
...
module.exports.isDerivedFromExtendedPublicKey = function(pub, xpub, i, p) {
  let hdKeyPair = hdkey.fromExtendedKey(xpub);
